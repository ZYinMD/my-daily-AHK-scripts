...
^+n::
  Run,%DirDropbox%\Coding\play\features\foobar2000\add-random-songs-to-foobar2000.sh,,Hide ;Hide is an argument which means run silently. Without it the bash shell will pop up then go away.
  ;deprecated:
